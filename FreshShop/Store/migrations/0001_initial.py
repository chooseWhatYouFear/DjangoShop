# Generated by Django 2.1.8 on 2019-07-24 11:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('good_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Store.Goods', verbose_name='商品id')),
            ],
        ),
        migrations.CreateModel(
            name='Seller',
            fields=[
                ...
                ('picture', models.ImageField(blank=True, null=True, upload_to='', verbose_name='用户头像')),
                ('address', models.CharField(blank=True, max_length=32, null=True, verbose_name='地址')),
                ('card_id', models.IntegerField(blank=True, null=True, verbose_name='身份证')),
            ],
        ),
        migrations.CreateModel(
            name='Store',
